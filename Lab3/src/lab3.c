...
void loadModels(){
	wmWalls = LoadModelPlus("../object/windmill-walls.obj");
	wmRoof = LoadModelPlus("../object/windmill-roof.obj");
	wmBalcony = LoadModelPlus("../object/windmill-balcony.obj");
	wmBlade = LoadModelPlus("../object/blade.obj");
