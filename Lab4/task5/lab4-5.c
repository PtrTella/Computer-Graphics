...
void init(void)
{
	...
	m = LoadModelPlus("../object/webtrcc.obj");
	...
	LoadTGATextureSimple("../texture/Grass_tile_B_diffuse.tga", &texGrass);
	...
	LoadTGATextureSimple("../texture/rock_02_dif.tga", &texMountain);
	LoadTGATextureSimple("../texture/rock_02_dif.tga", &texLake);
	LoadTGATextureSimple("../texture/fft-terrain.tga", &texTerrain);
	LoadTGATextureSimple("../texture/rock_01_dif.tga", &texSphere);
